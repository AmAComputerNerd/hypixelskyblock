...
public class challenging_rod extends SkyBlockItem {

	public challenging_rod(Material material, String name, String description, Rarity rarity, Type type, boolean stackable, boolean oneTimeUse, List<SBAbility> abilities, CustomRecipe craftingRecipe) {
		super(material, "CHALLENGE_ROD", name, description, rarity, type, stackable, oneTimeUse, abilities, Arrays.asList(new Stat(StatType.DAMAGE, 60, false), new Stat(StatType.STRENGTH, 60, false), new Stat(StatType.SEA_CREATURE_CHANCE, 2, false)), craftingRecipe);
	}
