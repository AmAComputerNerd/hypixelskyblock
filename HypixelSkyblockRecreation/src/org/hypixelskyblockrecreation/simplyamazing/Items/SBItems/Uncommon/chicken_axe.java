...
public class chicken_axe extends SkyBlockItem {

	public chicken_axe(Material material, String name, String description, Rarity rarity, Type type, boolean stackable, boolean oneTimeUse, List<SBAbility> abilities, CustomRecipe craftingRecipe) {
		super(material, "CHICKEN_AXE", name, description, rarity, type, stackable, oneTimeUse, abilities, new ArrayList<Stat>(), craftingRecipe);
	}
