...
public class bandaged_mithril_pickaxe extends SkyBlockItem {

	public bandaged_mithril_pickaxe(Material material, String name, String description, Rarity rarity, Type type, boolean stackable, boolean oneTimeUse, List<SBAbility> abilities, List<Attribute> attributes, CustomRecipe craftingRecipe) {
		super(material, "BANDAGED_MITHRIL_PICKAXE", name, description, rarity, type, stackable, oneTimeUse, abilities, Arrays.asList(new Stat(StatType.DAMAGE, 30, false), new Stat(StatType.MINING_SPEED, 250, false)), attributes, craftingRecipe);
	}
