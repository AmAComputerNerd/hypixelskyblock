...
public class auger_rod extends SkyBlockItem {

	public auger_rod(Material material, String name, String description, Rarity rarity, Type type, boolean stackable, boolean oneTimeUse, List<SBAbility> abilities, CustomRecipe craftingRecipe) {
		super(material, "AUGER_ROD", name, description, rarity, type, stackable, oneTimeUse, abilities, Arrays.asList(new Stat(StatType.DAMAGE, 135, false), new Stat(StatType.STRENGTH, 90, false)), craftingRecipe);
	}
