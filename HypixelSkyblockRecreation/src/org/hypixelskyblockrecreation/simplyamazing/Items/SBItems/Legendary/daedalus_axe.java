...
public class daedalus_axe extends SkyBlockItem {
	
	public daedalus_axe(Material material, String name, String description, Rarity rarity, Type type, boolean stackable, boolean oneTimeUse, List<SBAbility> abilities, CustomRecipe craftingRecipe) {
		super(material, "DAEDALUS_AXE", name, description, rarity, type, stackable, oneTimeUse, abilities, Collections.singletonList(new Stat(StatType.DAMAGE, 0, false)), craftingRecipe);
	}
